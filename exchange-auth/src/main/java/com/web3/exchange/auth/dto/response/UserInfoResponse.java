...
public class UserInfoResponse implements Serializable {
    ...
    public static UserInfoResponse from(UserDetailDTO userDetailDTO) {
        return UserInfoResponse.builder()
                .id(userDetailDTO.getId())
                .avatar(userDetailDTO.getAvatar())
                .status(userDetailDTO.getStatus())
                .createTime(userDetailDTO.getCreateTime())
                .deptId(userDetailDTO.getDeptId())
                .nickname(userDetailDTO.getNickname())
                .email(userDetailDTO.getEmail())
                .username(userDetailDTO.getUsername())
                .realName(userDetailDTO.getNickname())
                .phone(userDetailDTO.getPhone())
                .gender(userDetailDTO.getStatus())
                .genderText(userDetailDTO.getAvatar())
