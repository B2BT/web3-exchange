...
const rules: FormRules = {
  username: [
    ...
    { min: 3, max: 20, message: '账号长度 3-20', trigger: 'blur' },
  ],
  password: [
...
async function handleLogin() {
  ...
  try {
    ...
    if (authStore.userInfo?.role !== 'ADMIN') {
      ElMessage.error('该账号无管理员权限，禁止进入后台')
...
<template>
  <div class="admin-login-page">
    <div class="admin-login-card g-card">
      <div class="brand-logo">Web3 管理后台</div>
      <div class="subtitle">管理员专属 · 系统运营控制台</div>
      ...
      >
        ...
        <el-form-item label="验证码" prop="captcha">
          <div class="captcha-row">
            ...
            <div class="captcha-img" :title="'点击刷新验证码'" @click="loadCaptcha">
      ...
      <div class="login-footer">
        <el-link type="info" @click="router.push('/market')">← 返回前台</el-link>
      </div>
    </div>
  </div>
</template>
